   ...
   <div className='order-3 lg:order-1 gap-x-2 lg:w-1/3 '>
    ...
    <div className='menuButton'>
     <div
      ...
      <span
       className={`bg-gray-800 dark:bg-gray-400 block transition-all duration-300 ease-out 
     ...
     <motion.ul
      ...
      variants={variants}
      tabIndex={0}
      className={`absolute *:text-black  left-0 lg:hidden  menu menu-sm dropdown-content z-10 mt-3 p-2 shadow bg-slate-100 dark:bg-gray-600 rounded-box w-full flex flex-row items-center justify-center `}>
